...
class CommentCard extends StatelessWidget {
  ...
  void _showEditCommentDialog(BuildContext context) {
    final commentListBloc = context.read<CommentsListBloc>();
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<CommentsListBloc, CommentsListState, bool>(
      selector: (state) {
...
class __EditCommentDialogState extends State<_EditCommentDialog> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<CommentsListBloc, CommentsListState>(
      ...
      child: BlocSelector<CommentsListBloc, CommentsListState, bool>(
        selector: (state) {
