...
class UpdatePostUsecase implements UsecaseInterface {
  const UpdatePostUsecase({required this._postRepository});
    ...
    try {
      ...
      if (params.newImageFile != null) {
        if (params.originalPost.imageUrl != null) {
          await _postRepository.deletePostFolder(postId: params.originalPost.postId);
        }
