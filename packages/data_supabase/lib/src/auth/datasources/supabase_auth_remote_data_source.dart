...
class SupabaseAuthRemoteDataSource implements AuthRemoteDataSource {
  const SupabaseAuthRemoteDataSource({required this._supabaseClient});
  ...
  Future<UserModel> signup({
    ...
    try {
      ...
      throw UnknownException(
        message: 'An unexception error occurred while signup: ${e.toString()}',
      );
    }
  }
  ...
  Future<UserModel> login({
    ...
    try {
      ...
      throw UnknownException(
        message: 'An unexception error occurred while login: ${e.toString()}',
      );
    }
  }
